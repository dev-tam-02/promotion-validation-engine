...
-- -----------------------------------------------------------------------------
-- INSERT INTO engine_configs (id, timeout_ms, max_rules_fired, max_facts, max_nodes, max_depth, created_at)
-- VALUES ('config-default', 5000, 1000, 10000, 5000, 100, NOW());
...
-- -----------------------------------------------------------------------------
-- INSERT INTO time_policies (id, name, description, active, created_at)
-- VALUES ('policy-business-hours', 'Business Hours Policy', 'Chỉ cho phép trong giờ làm việc', TRUE, NOW());
