...
public class ValidateOrderResponse {
    ...
    public List<CampaignValidationResult> getResults() {
        return results;
    }

    public void setResults(List<CampaignValidationResult> results) {
    ...
    public static class ValidationSummary {
        ...
        public Integer getValidCampaigns() {
            return validCampaigns;
        }

        public void setValidCampaigns(Integer validCampaigns) {
            this.validCampaigns = validCampaigns;
        }

        public Integer getInvalidCampaigns() {
            return invalidCampaigns;
        }

        public void setInvalidCampaigns(Integer invalidCampaigns) {
