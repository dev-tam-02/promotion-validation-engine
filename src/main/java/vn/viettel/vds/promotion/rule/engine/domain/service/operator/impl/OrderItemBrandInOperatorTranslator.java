...
@Component
public class OrderItemBrandInOperatorTranslator implements OperatorTranslator {

    @Override
    public String translate(String nodeId, Map<String, Object> params, String reasonCode) {
        Object brands = params.get("brands");
        if (brands == null) {
            throw new IllegalArgumentException("Missing required parameter 'brands' for order.item.brand.in operator");
        }
    ...
    public boolean supports(String operatorName, Integer version) {
        return "order.item.brand.in".equals(operatorName) &&
