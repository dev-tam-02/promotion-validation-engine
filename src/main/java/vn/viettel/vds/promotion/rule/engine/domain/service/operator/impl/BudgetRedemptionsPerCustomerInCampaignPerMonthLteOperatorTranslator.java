...
/**
 * Counter-policy translator for {@code budget.redemptions.per_customer.in_campaign.per_month.lte}.
 *
 * <p>Bucket scope: {@code BucketKeys.customerInCampaignPerMonth(customerId, campaignId, now)}.
 */
@Component
public class BudgetRedemptionsPerCustomerInCampaignPerMonthLteOperatorTranslator implements OperatorTranslator {

    private static final String OPERATOR_NAME =
            "budget.redemptions.per_customer.in_campaign.per_month.lte";
    private static final String POLICY_NAME = "redemptions_per_customer_in_campaign_per_month";
    ...
    public String translate(String nodeId, Map<String, Object> params, String reasonCode) {
        ...
        return String.format(
                ...
                ".customerInCampaignPerMonth($c.getId(), \"%s\", java.time.Instant.now())));",
