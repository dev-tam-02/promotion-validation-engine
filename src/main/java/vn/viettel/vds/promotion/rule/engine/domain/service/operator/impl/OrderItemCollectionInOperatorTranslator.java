...
@Component
public class OrderItemCollectionInOperatorTranslator implements OperatorTranslator {

    @Override
    public String translate(String nodeId, Map<String, Object> params, String reasonCode) {
        Object collections = params.get("collections");
        if (collections == null) {
            throw new IllegalArgumentException("Missing required parameter 'collections' for order.item.collection.in operator");
        }

        List<String> collectionList = (List<String>) collections;
        StringBuilder sb = new StringBuilder();
        sb.append("        exists(OrderItem(collection in (");
    ...
    public String getOperatorName() {
        return "order.item.collection.in";
    }
    ...
    public boolean supports(String operatorName, Integer version) {
        return "order.item.collection.in".equals(operatorName) &&
