...
/**
 * Counter-policy translator for {@code budget.redemptions.per_customer.in_campaign.per_day.lte}.
 *
 * <p>Bucket scope: {@code BucketKeys.customerInCampaignPerDay(customerId, campaignId, now)}.
 */
@Component
public class BudgetRedemptionsPerCustomerInCampaignPerDayLteOperatorTranslator implements OperatorTranslator {

    private static final String OPERATOR_NAME =
            "budget.redemptions.per_customer.in_campaign.per_day.lte";
    private static final String POLICY_NAME = "redemptions_per_customer_in_campaign_per_day";
