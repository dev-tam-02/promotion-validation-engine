...
public class ValidationRuleConfig {
    ...
    public static class FastCheckRules {
        ...
        public Set<String> getAllowedDaysOfWeek() { return allowedDaysOfWeek; }
        ...
        public Set<String> getAllowedCurrencies() { return allowedCurrencies; }
