...
public class FastCheckConfigEntity {
    ...
    public static class TimeConstraints {
        ...
        // Getters and setters
        public List<BlackoutPeriod> getBlackoutPeriods() { return blackoutPeriods; }
        public void setBlackoutPeriods(List<BlackoutPeriod> blackoutPeriods) { this.blackoutPeriods = blackoutPeriods; }
        ...
        public List<String> getAllowedDaysOfWeek() { return allowedDaysOfWeek; }
        public void setAllowedDaysOfWeek(List<String> allowedDaysOfWeek) { this.allowedDaysOfWeek = allowedDaysOfWeek; }
        ...
        public List<FlashSaleWindow> getFlashSaleWindows() { return flashSaleWindows; }
        public void setFlashSaleWindows(List<FlashSaleWindow> flashSaleWindows) { this.flashSaleWindows = flashSaleWindows; }
    }
    ...
    public static class OrderConstraints {
        ...
        public void setMaxOrderValue(Long maxOrderValue) { this.maxOrderValue = maxOrderValue; }
    ...
    public static class CustomerConstraints {
        ...
        public List<String> getExcludedSegments() { return excludedSegments; }
        public void setExcludedSegments(List<String> excludedSegments) { this.excludedSegments = excludedSegments; }
        ...
        public boolean isRequireAllSegments() { return requireAllSegments; }
        public void setRequireAllSegments(boolean requireAllSegments) { this.requireAllSegments = requireAllSegments; }
    ...
    public OrderConstraints getOrderConstraints() { return orderConstraints; }
    public void setOrderConstraints(OrderConstraints orderConstraints) { this.orderConstraints = orderConstraints; }
    public CustomerConstraints getCustomerConstraints() { return customerConstraints; }
    public void setCustomerConstraints(CustomerConstraints customerConstraints) { this.customerConstraints = customerConstraints; }
    public RateLimitConfig getRateLimits() { return rateLimits; }
    public void setRateLimits(RateLimitConfig rateLimits) { this.rateLimits = rateLimits; }
